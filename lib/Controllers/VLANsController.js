...
class VLANsController {
     ...
     * @param {Body70Model} body (optional) TODO: type description here
     *
    ...
    static updateNetworkVlan(networkId, vlanId, body, callback) {
        ...
        } else if (vlanId === null || vlanId === undefined) {
            const _err = { errorMessage: 'The parameter `vlanId` is a required parameter and cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     *
     * @param {string} networkId TODO: type description here
     * @param {Body71Model} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     ...
     *
     * @param {string} networkId TODO: type description here
     * @param {Body69Model} body TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
