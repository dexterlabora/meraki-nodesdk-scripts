...
/**
 * Creates an instance of Body38Model
 */
class Body38Model extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'tags', realName: 'tags', array: true, type: 'Tag2Model' },
            { name: 'networks', realName: 'networks', array: true, type: 'Network2Model' },
        ]);
    }
